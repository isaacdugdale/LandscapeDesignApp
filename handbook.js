...
{id:'site', group:'site', nav:'The site', title:'The site', sub:'Levels, soil, and why it is a Class P site', blocks:[
  ...
  ['note','Keeping the pear is the sounder choice structurally. Trees near footings draw moisture from the soil; remove one and the soil beneath slowly takes up water again and swells. Tree 2 stands about 4 m from the rear addition and the engineer’s assessment assumes it stays, so removing it later would risk the ground lifting under the new slab. Retaining it keeps the assessment valid. The practical consequence is that the pear needs to come through the build in reasonable health: root pruning held to the approved minimum, arborist supervision as the plan requires, and the mulching and watering actually done.'],
  ...
  ['ul',[
    'Cut deeper than 0.5 m or fill thicker than 0.4 m triggers a reassessment of the classification. The design stays inside this: the firepit is a 450 mm cut, the firepit terrace balances cut and fill within the free pocket, and the rear swale is formed within 100 mm of mulch.',
...
{id:'water', group:'site', nav:'How water moves', title:'How water moves', sub:'Roof, reserve and subsurface flows', blocks:[
  ...
  ['note','The garage roof is the one to watch. Because the existing house gutters discharge onto it, that roof carries a combined catchment rather than its own 44.9 m² — between 75 and 95 m² depending on how much of the house drains that way, which is 3.0 to 3.7 litres a second at the standard used for sizing gutters. At roughly 47 m² per 90 mm downpipe that needs two and possibly three downpipes. It sits against the courtyard on one side and 123 mm off the boundary on the other, so confirm which way it falls, where the gutter runs, how many downpipes there are and where they discharge — none into the courtyard, all positively connected. With the house feeding it, a single blocked gutter backs up a large volume, and the overflow has to go somewhere.'],

  ['h','Surface flow from the reserve'],
  ['p','The walking path outside the rear fence runs along a raised, man-made formation. The ground on the uphill side sits lower than the path crest, so the path works as a bank across the slope. Photographed in a February storm, the crest stands above the ground either side and holds water rather than shedding it, and the runoff coming off it is orange and heavily silted — which is what arrives in anything that catches it.'],
  ...
  ['note','The bank changes the shape of the risk rather than removing it. Almost nothing arrives most of the time, and then a large volume could arrive quickly if the bank overtops at a low point or a section gives way. What is released is limited by how much water was ponded, not by rainfall. Ponding 50 m long, 15 m wide and 300 mm deep is roughly 110 cubic metres: about 170 litres a second over ten minutes, more than 300 over five.'],
  ['p','This is why the overland flow path along the side boundary must stay open, continuous and unobstructed to the street. It carries 236 litres a second and is the thing that would handle a release of that kind. Nothing gets built across it — no shed, no raised bed, no fence, no stack of pavers.'],
  ['p','Two further points. The runoff on the path is orange and heavily silted, so anything catching water here catches sand and fine sediment too, which is the argument for a silt sump you can shovel out. And the bank is almost certainly an ACT asset rather than yours, so report erosion, a dip forming or a rill through it through Fix My Street rather than repairing it yourself, and do not assume it will be maintained forever.'],
...
{id:'trees', group:'site', nav:'Trees and approvals', title:'Trees and approvals', sub:'What the tree plan permits inside a protection zone', blocks:[
  ['p','Five protected trees were assessed. Hand excavation around the pear is approved and under way with the arborist’s sign-off, so it is worth setting out precisely what is allowed inside a protection zone, because the general notes on the tree protection drawing read more restrictively than the clauses behind them.'],
  ['tbl',[
  ...
  ['ul',[
    'The apron and subsoil drain at the addition’s uphill wall are achievable now, using the same method, tree and supervision as the footing excavation already approved. They need adding to the approved scope, and belong in the builder’s works rather than the later landscaping, because they are building perimeter drainage. The apron cut of about 410 mm also stays under the 500 mm that would trigger a site reclassification.',
    ...
    'A new drainage line through the pear’s zone would need the plan amended. Clause 6.5.2 rules out additional services through a zone unless specified, which is why the sleeves cast into the garage slab are the recommended route out of the back garden: no tree approval, no supervision, and no risk of meeting a root you are not allowed to cut halfway along a trench. A hand-excavated or bored line through the zone is the fallback, with the plan amended first.'
  ]],
  ['note','One inconsistency to raise with the arborist. The general notes on the tree protection drawing give a minimum bored depth of 700 mm for services, while clause 6.5.1 says 1,000 mm. Use the stricter figure unless he confirms otherwise. It matters for the stormwater outlet across the street tree’s zone, where boring at either depth would put the invert below the kerb, so that crossing has to be hand or hydro excavated, which 6.5.1 expressly allows.'],
...
{id:'drainage', group:'works', nav:'Drainage', title:'Drainage design', sub:'The two lines, the numbers, and the route out', blocks:[
  ...
  ['p','Two DN100 sleeves cast under the garage slab — one from the rear pocket, one from the enclosed courtyard — run to the driveway entirely clear of every protection zone, and neither passes under the link. From there they reach the kerb through the existing crossover at the north-east corner, the only part of the verge outside the street trees’ zones. Invert 610.01 at the boundary against a kerb at 609.85, a fall of 1 in 50 across the verge, so it works by gravity. Both cost very little while the slab is being formed and become a serious problem afterwards.'],
  ...
  ['p','A DN150 spine runs the length of the block 2.5 m off the side boundary, clear of every zone, picking up the rear half of the house roof, the paving and the paths. It carries 5.3 litres a second in the design storm against a capacity of 45. Its outlet crosses tree 5’s zone, so the last few metres must be hand or hydro excavated with the arborist present rather than bored — at the depth a bore requires, the invert would land below the kerb and could not discharge. Better still, find out whether the house already has a kerb outlet and reuse it.'],
...
{id:'earth', group:'works', nav:'Earth shaping', title:'Earth shaping', sub:'Getting water into the ground, and past the house', blocks:[
  ...
  ['p','The gum’s trunk stands only 1.97 m from the rear boundary, and its structural root zone — the inner circle where nothing may be excavated, not even by hand — has a radius of 2.8 m, so it crosses the boundary by 830 mm. A channel following that boundary would pass within about 1.2 m of the trunk, which is why the swale is confined to the corner.'],
  ['kv',[
  ...
  ['note','Two details matter more than the dimensions. Line the upstream end with rock, generously, because concentrated flow off the path arrives there with energy. And put a silt trap in the pit — a sump below the outlet with a removable grate — because a channel collecting hillside runoff brings sand and leaf litter, and shovelling that from a sump once a year is far easier than clearing it from the pipe under the garage.'],

  ['h','The mulch blanket — what works across the middle'],
  ['p','For the twelve or so metres of boundary in front of the gum there is no channel and cannot be one. Water crosses there and spreads as a thin sheet, as it does now. What handles it is the 100 mm layer of coarse woodchip the tree plan already requires. Coarse chip over sandy soil absorbs a surprising volume, and more importantly spreads flow and slows it rather than letting it collect into rivulets. Use coarse grade, around 25 mm, not fine or shredded — fine mulch floats. Lay logs or rock across the slope in the steeper pockets, as the reserve revegetation has done on the other side of the fence.'],

  ['h','The diversion bund above the addition'],
  ['p','A low ridge a few metres uphill of the addition’s rear wall, angled so sheet flow crossing the woodland floor is turned aside into the side strip rather than continuing into the wall. It sits inside both trees’ protection zones, so it is built up rather than dug: 100 mm of added material maximum, hand placed, arborist supervising. Build it from coarse woodchip rather than soil — 100 mm of clay or topsoil over a mature gum’s root plate reduces the air reaching the roots, which is the reason the 100 mm cap exists. Make it wide and rounded rather than a sharp berm, so it overtops evenly along its length instead of breaching at one point. It is a Diversion berm in the element library, so it sits on the plan as a curved run you can move and the Checks screen asks it the two questions this paragraph is really about: whether the ground falls along it so water leaves past an end, and whether it runs past both corners of the wall it stands in front of.'],
...
{id:'planting', group:'works', nav:'Planting', title:'Planting', sub:'Zone by zone, working outward from the house', blocks:[
  ...
  ['p','Spread 100 mm of coarse woodchip, which the tree plan requires anyway, and plant small tubestock through it into hand-dug holes, with beds built up on the surface rather than cut in. Bursaria, Correa, Rhagodia, Poa, Dianella and Lomandra all cope. Expect slow establishment and hand water through the first two summers, after which they look after themselves. This becomes the low-maintenance part of the garden once away.'],
...
{id:'courtyard', group:'works', nav:'The courtyard', title:'The courtyard', sub:'Deep shade, no natural outlet, everything in pots', blocks:[
  ...
  ['p','Bromeliads are the doubtful ones while the maple is alive, wanting brighter indirect light than this. Expect slow growth and poor colour for now and better conditions once the canopy goes. Group the pots rather than spreading them out, which raises local humidity and makes hand watering quicker, and keep plants spaced and off the walls, because still humid air in a shaded enclosure encourages fungal problems.'],
...
{id:'paved', group:'works', nav:'Terrace and kitchen', title:'Paved terrace and outdoor kitchen', sub:'Where they can go, and why', blocks:[
  ...
  ['ul',[
    'Paving inside a tree protection zone has to be built up, not cut in. Clause 6.6.3 of the tree plan requires paths and beds inside a zone to sit above existing grade with no excavation and no compaction, so a conventional excavated base course is not available there. The permitted build-ups are cellular geotextile, or rumble boards over 200 mm of coarse woodchip, or rated mats. They work but are awkward to finish neatly under paving, so it is simpler to keep the paved area clear of the zone.',
...
{id:'risks', group:'risks', nav:'Risks', title:'Risks and what stops them', sub:'Ten items, in plain terms', blocks:[
  ...
  ['p','What happens. The ground outside the addition’s uphill wall is higher than the floor inside it, by about 260 mm. Rain running down the slope arrives at that wall with nowhere to go, so it sits and soaks in. Soil that stays permanently damp against one wall while the rest of the house dries out normally makes the ground move unevenly, which shows up as cracks, doors that stick, and in the worst case damp through the wall.'],
  ...
  ['p','What happens. The soil beside the house is clay that swells when wet and shrinks when dry. Keeping one part constantly damp — a watered bed, a leaking tap, a timer running all summer — while the rest goes through normal cycles makes the ground rise there relative to the rest. The house is rigid and the ground is not.'],
  ...
  ['p','Why here. The photographs show the path, along with logs laid across the slope and heavy mulching — erosion-control works, so somebody has already concluded this ground moves water.'],
  ...
  ['p','What stops it. Coarse grade chip, around 25 mm, not fine or shredded — coarse chip knits together and stays put. Lines of logs or rock across the slope in the steeper pockets, the same technique already used in the reserve.']
]}
